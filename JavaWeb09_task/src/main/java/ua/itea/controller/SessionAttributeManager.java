...
public class SessionAttributeManager {
	...
	public <T extends SessionAttribute> boolean hasAttribute(Class<T> clazz, String ...nameEnding) {
	...
	public <T extends SessionAttribute> void ensureAttribute(T attribute, String ...nameEnding) {
		final String attrName = getAttributeName(attribute.getClass(), nameEnding);
	...
	public <T extends SessionAttribute> void ensureAttribute(Class<T> clazz, String ...nameEnding) {
		final String attrName = getAttributeName(clazz, nameEnding);
		final T attr = retrieveAttribute(attrName);
